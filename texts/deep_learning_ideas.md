...
![An Image from the paper of CyCADA summarizing a lot of what I've talked about: A combination of annotations, components, synthetic elements, architecture as in electronics and joint training of all the network.](synthetic_media.png)>
