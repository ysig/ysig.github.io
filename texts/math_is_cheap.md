...
One of the most notable achievements in computer where the complexity bounds, Turing machines and proofs of what a machine can't do.
...
As math is an infrastructure itself, as it happens with any language, numpy, scikit-learn, pytorch etc and thus becomes part of a latent language which sometimes is only, by making things usable and feasible or performative.
